...
assistent = Virtual_assist('Luci', 'Don')
...
while True:
    ...
    if assistent.there_exist(['bye', 'goodbye', 'seeyou', 'see you later', 'see you', 'shutdown']):
        assistent.engine_speak("Have a nice day sir Don, good bye!")
        break